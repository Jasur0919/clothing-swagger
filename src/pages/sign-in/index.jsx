...
const Index = () => {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-gray-100 sign">
      <div className="w-full max-w-2xl h-3/5 px-20 py-8 bg-white rounded-[30px] rounded-br-[30px] shadow-md opacity-90">
        <h1 className="text-5xl font-bold text-center text-black">Log-In</h1>
        <Formik
          initialValues={{
