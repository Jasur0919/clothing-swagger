              ...
              <StyledTableRow key={index}>
                ...
                <StyledTableCell align="center">
                  <div className="flex items-center space-x-4 justify-center">
                    ...
                    /> */}
                    <MdOutlineEdit onClick={() => editItem(item)}
                      src={editImg}
                      alt="edit"
                      className="cursor-pointer hover:scale-125 transition-all duration-200 text-blue-600 text-[25px]"/>

                    <FaTrashAlt     onClick={() => deleteItem(item.category_id)}
                      src={deleteImg}
                      alt="delete"
